                    ...
                    <section>
                        <form method="POST" action="{{ route('posts.update', $post->slug) }}" class="space-y-6">
                            ...
                            <div>
                                ...
                                <textarea id="content" name="body" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" rows="6" required>{{ old('body', $post->body) }}</textarea>
                            ...
                            <div>
                                <label for="is_draft" class="inline-flex items-center">
                                    <input id="is_draft" type="checkbox" value="1" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" name="is_draft" {{ old('is_draft', $post->is_draft) ? 'checked' : '' }}>
